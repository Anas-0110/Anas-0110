...
const uri = "mongodb+srv://Anas_Ikhwan:XGZgn0hYSUipQCAO@cluster0.jgb94.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.get('/login', async (req,res) => {
   const user= await client.db("anas").collection("anas0110").findOne(
...
app.post('/register', async (req,res) => {
   ...
   client.db("anas").collection("anas0110").insertOne({
      "name": req.body.name,
